module ActivationMem #(
    parameter INIT_FILE = "NONE",
    parameter NUM_BANKS = 76
)(
    input clk,
    input rst_n,
...
genvar bank;
generate
    for(bank = 0; bank < NUM_BANKS; bank = bank + 1) begin : g_act_bank
...
`ifndef SYNTHESIS
        ...
        initial begin
            ...
            if((bank == 0) && (INIT_FILE != "NONE")) begin
