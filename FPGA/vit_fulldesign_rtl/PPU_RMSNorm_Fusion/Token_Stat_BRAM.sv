...
module Token_Stat_BRAM #(
    ...
    localparam int ADDR_PAD_W = BRAM_AW - TOKEN_AW;
    localparam logic [TOKEN_AW-1:0] TOKEN_NUM_L = TOKEN_NUM;
    ...
    assign wr_in_range = (wr_addr_i < TOKEN_NUM_L);
    assign rd_in_range = (rd_addr_i < TOKEN_NUM_L);
